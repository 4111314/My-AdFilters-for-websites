...
注：本来我想通过v2rayN等代理软件的路由规则来实现对网站的屏蔽，但我使用的是白名单规则，这样的话，因为名单不可能完全精准，某些打不开的网站，也不知道是想屏蔽的还是路由规则的问题导致打不开。而Ublock Origin可以直接以一种非常简洁明了的方式拦截住，并且我可以看到拦截它的规则。只要规则属于我写的这些列表，那么它明显就是我想屏蔽的网站。这样可以很明显地进行区分。
